...
export class GridContainerLayout implements cytoscape.CoreLayout {
  ...
  layout(layout: cytoscape.LayoutOptions): cytoscape.LayoutManipulation {
    return this.core;
  }
  makeLayout(options: cytoscape.LayoutOptions): cytoscape.LayoutManipulation {
    return this.core;
  }
}
